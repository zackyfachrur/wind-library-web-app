          ...
          <section class="flex items-center justify-center w-full h-full m-auto">
               <div class="flex flex-col items-center justify-center gap-3 h-96">
                    ...
                    <p class="text-base font-semibold"><span
                              class="px-2 font-bold text-white bg-black rounded-full">Mengetahui lebih jauh tetang Wind
                              Library. </span>
                    </p>
                    ...
                    <img src="../img/shapes-3.png" alt="Decoration Image" class="absolute w-96 translate-y-20 right-20">
               </div>
          </section>
          <!-- End About -->
